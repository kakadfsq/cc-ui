...
import type { INotificationOptions, INotification, NotificationQueue, NotificationVM, Position } from "./notification";
 ...
 */
export function close(id: string, position: Position, userOnClose?: (vm: NotificationVM) => void): void {
  ...
  for (let i = idx; i < len; i++) {
    ...
    const pos = parseInt(orientedNotifications[i].vm.el.style[verticalPos], 10) - removedHeight - 16;
